...
export var serializeAws_restXmlChangeCidrCollectionCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body, bodyNode, nodes, containerNode_1, node;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                if (input.CollectionVersion !== undefined) {
                    node = new __XmlNode("CollectionVersion")
...
export var serializeAws_restXmlChangeTagsForResourceCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, labelValue, body, bodyNode, nodes, containerNode_2, nodes, containerNode_3;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                if (input.CallerReference !== undefined) {
                    node = new __XmlNode("CidrNonce")
                        .addChildNode(new __XmlText(input.CallerReference))
                        .withName("CallerReference");
                    bodyNode.addChildNode(node);
                }
                if (input.Name !== undefined) {
                    node = new __XmlNode("CollectionName").addChildNode(new __XmlText(input.Name)).withName("Name");
                    bodyNode.addChildNode(node);
                }
                body += bodyNode.toString();
                return [2, new __HttpRequest({
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                query = __assign(__assign(__assign({}, (input.LocationName !== undefined && { location: input.LocationName })), (input.NextToken !== undefined && { nexttoken: input.NextToken })), (input.MaxResults !== undefined && { maxresults: input.MaxResults.toString() }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restXmlListTagsForResourcesCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body, bodyNode, nodes, containerNode_4;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
...
export var serializeAws_restXmlUpdateHealthCheckCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body, bodyNode, node, nodes, containerNode_5, node, node, node, node, node, node, node, node, node, node, nodes, containerNode_6, nodes, containerNode_7, node, node;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
...
var serializeAws_restXmlCidrList = function (input, context) {
    return input
        ...
        var node = new __XmlNode("Cidr").addChildNode(new __XmlText(entry));
